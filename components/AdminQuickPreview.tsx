        ...
        {candidateInfo ? (
          <div className="p-6 grid grid-cols-3 gap-4">
            {([
              ...
              { key: 'identity', label: isCN ? '身份' : 'Identity', type: 'select', options: ['Undergraduate', 'Master', 'MBA', 'PhD'] },
              { key: 'school', label: isCN ? '学校' : 'School' },
              { key: 'department', label: isCN ? '院系' : 'Department' },
              { key: 'major', label: isCN ? '专业' : 'Major' },
              { key: 'gradeOrLevel', label: isCN ? '年级' : 'Grade' },
